...
public class AppUtil {
    ...
    public static String generatePeriodFormat(int currentNo,int numOfPlayer){
        String periodFormat="%0"+String.valueOf(numOfPlayer).length()+"d"+"/"+numOfPlayer;
        return String.format(periodFormat, currentNo);
    }
}
